...
#ifndef __INET_ETHER_DUPLEX_MAC_NEW_H
#define __INET_ETHER_DUPLEX_MAC_NEW_H

#include "INETDefs.h"

#include "EtherMACFullDuplex.h" //EXTRA-IMY
 ...
 */
class INET_API EtherMACFullDuplexNew : public EtherMACFullDuplex
{
