...
void UDPFlowHost::startFlow(unsigned int transferRate, unsigned long long flowSize, unsigned int frameSize, const IPvXAddress& destAddr) //Kbps, B(KB*1000), B, address
{
