...
#ifndef WAPB_SRC_ROUTING_AODV_AODVROUTING_H_
#define WAPB_SRC_ROUTING_AODV_AODVROUTING_H_
...
class AODVRoutingEdited : public cSimpleModule, public ILifecycle, public INetfilter::IHook, public cListener
{
  protected:
    /*
    ...
    int numRREQCreated = 0;
    int numRREPCreated = 0;
    int numRERCreated = 0;
    int numGratuitousRREPCreated = 0;

    int numRREQForwarded = 0;
    int numRREPForwarded = 0;
    int numRERForwarded = 0;
    int numGratuitousRREPForwarded = 0;

    int numStartRouteDiscovery = 0;
  ...
  public:
    AODVRoutingEdited();
    virtual ~AODVRoutingEdited();
};

} // namespace wapb

#endif    // ifndef WAPB_SRC_ROUTING_AODV_AODVROUTING_H_
