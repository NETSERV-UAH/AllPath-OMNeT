...
#ifndef WAPB_SRC_SIMULATIONMODELS_STATISTIC_STATISTICCOLLECTOR_H_
#define WAPB_SRC_SIMULATIONMODELS_STATISTIC_STATISTICCOLLECTOR_H_
...
#endif // ifndef WAPB_SRC_SIMULATIONMODELS_STATISTIC_STATISTICCOLLECTOR_H_
