...
#ifndef WAPB_SRC_LINKLAYER_IEEE80211_MAC_CONTENTIONWAPB_H
#define WAPB_SRC_LINKLAYER_IEEE80211_MAC_CONTENTIONWAPB_H
 ...
 */
class ContentionWAPB : public cSimpleModule, public IContention
{
    public:
    ...
    protected:
        ...
        //EXTRA
        unsigned int backoffSeed = 0;     //Seed for random backoff
