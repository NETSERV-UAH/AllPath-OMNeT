...
#ifndef WAPB_LINKLAYER_ETHERNET_ARPPATHSWITCH_BLOCKINGTABLENEWAPB_H_
#define WAPB_LINKLAYER_ETHERNET_ARPPATHSWITCH_BLOCKINGTABLENEWAPB_H_
 ...
 */
class BlockingTableNewWAPB : public cSimpleModule
{
  protected:
...
#endif // ifndef WAPB_LINKLAYER_ETHERNET_ARPPATHSWITCH_BLOCKINGTABLENEWAPB_H_
