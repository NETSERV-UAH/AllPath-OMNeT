...
#ifndef SRC_LINKLAYER_ETHERNET_ETHERMACFULLDUPLEXNEW_H
#define SRC_LINKLAYER_ETHERNET_ETHERMACFULLDUPLEXNEW_H
 ...
 */
class  EtherMACFullDuplexNew : public EtherMACBase
{
  public:
...
#endif // ifndef SRC_LINKLAYER_ETHERNET_ETHERMACFULLDUPLEXNEW_H
