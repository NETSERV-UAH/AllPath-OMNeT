/*
 * ArpPathMacAddressTable.h
 *
 *  Created on: ?? «—œ?»Â‘  ???? Âû.‘.
 *      Author: Simject
 */

#ifndef SRC_LINKLAYER_ETHERNET_ARPPATHSWITCH_ARPPATHMACADDRESSTABLE_H_
#define SRC_LINKLAYER_ETHERNET_ARPPATHSWITCH_ARPPATHMACADDRESSTABLE_H_
...
class ArpPathMacAddressTable
{
  ...
  public:
    ...
    ArpPathMacAddressTable();
    ArpPathMacAddressTable(simtime_t agingTime);
    ~ArpPathMacAddressTable();
...
#endif /* SRC_LINKLAYER_ETHERNET_ARPPATHSWITCH_ARPPATHMACADDRESSTABLE_H_ */
