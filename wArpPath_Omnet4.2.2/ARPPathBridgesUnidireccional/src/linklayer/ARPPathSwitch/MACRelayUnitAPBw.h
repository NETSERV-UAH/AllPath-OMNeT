...
#ifndef __ARPPATHBRIDGESUNIDIRECCIONAL_MACRELAYUNITAPBW_H_
#define __ARPPATHBRIDGESUNIDIRECCIONAL_MACRELAYUNITAPBW_H_
 ...
 */
class MACRelayUnitAPBw : public MACRelayUnitBase
{
    friend class Ieee80211MgmtAdhocAPB;
public:
        MACRelayUnitAPBw();
        virtual ~MACRelayUnitAPBw();

/*MACRelayUnitNP.h (start)*/
     protected:
        // the shared queue
        cQueue queue;
...
/*MACRelayUnitAPB extension from here...*/
     ...
     protected:
        ...
        virtual void addEntryw(AddressEntry entry, MACAddress address, MACAddress next_h);
